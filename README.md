...
It started as a searcher for the 250 top movies on IMDB. However, using polymorphism it grew as a generic content API consumer. It is consuming both IMDB and Marvel's API.
